...
ActiveRecord::Schema.define(version: 20180419065735) do
  ...
  create_table "messages", force: :cascade do |t|
    t.datetime "date"
    t.boolean "sent_by_user", default: false
    t.string "subject"
    t.text "text"
  ...
  create_table "user_selections", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.bigint "company_id"
    t.index ["company_id"], name: "index_user_selections_on_company_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "avatar"
    t.boolean "agree_with_policy", default: false
